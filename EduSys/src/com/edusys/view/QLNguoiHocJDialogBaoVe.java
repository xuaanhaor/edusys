 ...
 * @author THUAN
 */
public class QLNguoiHocJDialogBaoVe extends javax.swing.JDialog {

    /**
     * Creates new form QLNguoiHocJDialog
     */
    public QLNguoiHocJDialogBaoVe(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        tblNguoiHoc.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MA NH", "HO TEN", "GIOI TINH", "NGAY SINH", "SDT", "EMAIL", "MANV", "NGAYDK", "HINH", "TRINHDO"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLNguoiHocJDialogBaoVe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QLNguoiHocJDialogBaoVe dialog = new QLNguoiHocJDialogBaoVe(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            for (NguoiHoc nh : list) {
                Object[] row = new Object[]{nh.getMaNH(), nh.getHoTen(), nh.getGioiTinh() ? "Nam" : "Nữ", XDate.toString(nh.getNgaySinh(), "dd/MM/yyyy"), nh.getDienThoai(), nh.getEmail(),
                    nh.getMaNV(), XDate.toString(nh.getNgayDK(), "dd/MM/yyyy"), nh.getHinh(), nh.getTrinhDo()
                };
                model.addRow(row);
            }
        } catch (Exception e) {
...
//        nh.setHinh(lblHinh.getToolTipText() == null ? "" : lblHinh.getToolTipText());
    ...
    void setForm(NguoiHoc nh) {
        ...
        //trinh do
        if ("Đại học".equalsIgnoreCase(nh.getTrinhDo())) {
            rdoDaiHoc.setSelected(true);
        } else if("Cao đẳng".equalsIgnoreCase(nh.getTrinhDo())) {
